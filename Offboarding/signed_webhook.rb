require 'base64'
#signed_webhook.rb - test signed webhook params
require 'digest'
require 'openssl'
require 'json'
...
puts "Enter JSON Escaped Payload:"
payload = gets.chomp
payload = JSON.parse(payload)
puts "Enter X_TWILIO_EMAIL_EVENT_WEBHOOK_SIGNATURE:"
signature = gets.chomp
puts "Enter X_TWILIO_EMAIL_EVENT_WEBHOOK_TIMESTAMP:"
timestamp = gets.chomp
webhook = SendGrid::EventWebhook.new
ecdsa_public_key = webhook.convert_public_key_to_ecdsa(public_key)
puts webhook.verify_signature(ecdsa_public_key, payload, signature, timestamp)
